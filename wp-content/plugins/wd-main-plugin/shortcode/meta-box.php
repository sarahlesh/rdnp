...
if ( !class_exists('myCustomFields') ) {
	...
	class myCustomFields {
		...
		*/
		...
		// ---------------------Pages---------------------
			array(
				"name"			=> "nonprofit_page_show_title_area",
			...
			array(
				"name"			=> "nonprofit_page_title_area_style",
			...
			array(
				"name"			=>	"nonprofit_page_title_area_bg_color",
			...
			array(
				"name"			=> "nonprofit_page_show_title",
				"title"			=> "Show title",
				"description"	=> "",
				"float_left" 	=> "yes",
				"clear_after" 	=> "",
			...
			array(
				"name"			=> "nonprofit_page_title_position",
			...
			array(
				"name"			=> "nonprofit_page_title_fontsize",
			...
			array(
				"name"			=>	"nonprofit_page_title_color",
