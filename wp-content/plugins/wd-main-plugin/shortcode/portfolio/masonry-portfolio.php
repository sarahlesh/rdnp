<ul class="wd-portfolio-masonry <?php echo esc_attr($nonprofit_portfolio_hover_style); ?> large-block-grid-<?php echo esc_attr($nonprofit_portfolio_columns_desktop); ?> medium-block-grid-<?php echo esc_attr($nonprofit_portfolio_columns_tablet); ?> small-block-grid-<?php echo esc_attr($nonprofit_portfolio_columns_mobile); ?>" data-padding="<?php echo esc_attr($padding_items) ?>">
    <?php 
              ...
              case 'style-1':
                ...
                <div class="wd-portfolio-masonry-item-image">
                  <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                    <?php $thumb = get_post_thumbnail_id(); $img_url = wp_get_attachment_url( $thumb,'full' ); $image = nonprofit_resize( $img_url, 584, true ); ?>
