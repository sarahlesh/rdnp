<ul class="wd-portfolio-grid <?php echo esc_attr($nonprofit_portfolio_hover_style); ?> large-block-grid-<?php echo esc_attr($nonprofit_portfolio_columns_desktop); ?> medium-block-grid-<?php echo esc_attr($nonprofit_portfolio_columns_tablet); ?> small-block-grid-<?php echo esc_attr($nonprofit_portfolio_columns_mobile); ?>" data-padding="<?php echo esc_attr($padding_items) ?>">
<?php 
$overlay_width = '';
if ($nonprofit_static_html_item_position == "before"){ ?>
  <li class="static-html-item wd-portfolio-grid-item <?php echo esc_attr($nonprofit_static_html_item_width) ?>">
    <div class="static-html-item-container" style="background-color: <?php echo esc_attr($nonprofit_static_html_item_bg_color); ?>">

      <?php 
       echo $nonprofit_static_html_item ;
       ?>
    </div>
  </li>
<?php } ?>
              ...
              case 'style-1':
                ...
                <div class="wd-portfolio-grid-item-image">
                  <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                    <?php $thumb = get_post_thumbnail_id(); $img_url = wp_get_attachment_url( $thumb,'full' ); $image = nonprofit_resize( $img_url, 946, 802, true, true, true ); ?>
    ...
    <?php if ($nonprofit_static_html_item_position == "after"){ ?>
      <li class="static-html-item wd-portfolio-grid-item <?php echo esc_attr($nonprofit_static_html_item_width) ?>">
      <div style="static-html-item-container" style="background-color: <?php echo esc_attr($nonprofit_static_html_item_bg_color); ?>">
        <?php echo esc_attr($nonprofit_static_html_item) ; ?>
      </div>
      </li>
    <?php } ?>
    </ul>
