    ...
    ?>
      ...
      switch ($_GET['shortcode']) {
        case 'portfolio': 
          ...
          <form name="nonprofit_shortcodes" action="#">
          ...
          <form name="nonprofit_shortcodes" action="#">
            <table border="0" cellpadding="4" cellspacing="0">
            	<tr>
            		...
            		<td>
            			<input type="text"  name="nonprofit_map_title" id="nonprofit_map_title">
            		</td>
            	</tr>
            	<tr>
            		<td><?php _e("Company Name", THEME_NAME); ?>:</td>
            		<td>
            			<input type="text"  name="nonprofit_map_company_name" id="nonprofit_map_company_name">
            		</td>
            	</tr>
            	<tr>
            		<td><?php _e("Description", THEME_NAME); ?>:</td>
            		<td>
            			<input type="text"  name="nonprofit_map_description" id="nonprofit_map_description">
            		</td>
            	</tr>
            	<tr>
            		<td><?php _e("Latitude", THEME_NAME); ?>:</td>
            		<td>
            			<input type="text"  name="nonprofit_map_latitude" id="nonprofit_map_latitude">
            		</td>
            	</tr>
            	<tr>
            		<td><?php _e("Longitude", THEME_NAME); ?>:</td>
            		<td>
            			<input type="text"  name="nonprofit_map_longitude" id="nonprofit_map_longitude">
            		</td>
            	</tr>
            	<tr>
            		<td><?php _e("Zoom", THEME_NAME); ?>:</td>
            		<td>
            			<select id="nonprofit_zoom">
            	...
            	<tr>
            		...
            		<td>
            			<input type="text"  name="nonprofit_map_height" id="nonprofit_map_height">
            		</td>
            	</tr>
            </table>
            <br/><br/>
