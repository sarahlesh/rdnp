...
$nonprofit_fonts_array = unserialize($fontsSeraliazed);
...
$vc_add_css_animation = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'CSS Animation', 'nonprofit' ),
	'param_name' => 'css_animation',
	'admin_label' => true,
	'value' => array(
		esc_html__( 'No', 'nonprofit' ) => '',
		esc_html__('Expand In', 'nonprofit' ) => 'expandIn',
		esc_html__('Bounce In', 'nonprofit' ) => 'bounceIn',
		esc_html__('Bounce In Down', 'nonprofit' ) => 'bounceInDown',
		esc_html__('Bounce In Left', 'nonprofit' ) => 'bounceInLeft',
		esc_html__('Bounce In Right', 'nonprofit' ) => 'bounceInRight',
		esc_html__('Bounce In Up', 'nonprofit' ) => 'bounceInUp',
		esc_html__('Fade In', 'nonprofit' ) => 'fadeIn',
		esc_html__('Fade In Down', 'nonprofit' ) => 'fadeInDown',
		esc_html__('Fade In Down Big', 'nonprofit' ) => 'fadeInDownBig',
		esc_html__('Fade In Left', 'nonprofit' ) => 'fadeInLeft',
		esc_html__('Fade In Left Big', 'nonprofit' ) => 'fadeInLeftBig',
		esc_html__('Fade In Right', 'nonprofit' ) => 'fadeInRight',
		esc_html__('Fade In Right Big', 'nonprofit' ) => 'fadeInRightBig',
		esc_html__('Fade In Up', 'nonprofit' ) => 'fadeInUp',
		esc_html__('Fade In Up Big', 'nonprofit' ) => 'fadeInUpBig',
		esc_html__('Flip', 'nonprofit' ) => 'flip',
		esc_html__('Flip In X', 'nonprofit' ) => 'flipInX',
		esc_html__('Flip In Y', 'nonprofit' ) => 'flipInY',
		esc_html__('Flip Out X', 'nonprofit' ) => 'flipOutX',
		esc_html__('Flip Out Y', 'nonprofit' ) => 'flipOutY',
		esc_html__('Light Speed In', 'nonprofit' ) => 'lightSpeedIn',
		esc_html__('Light Speed Out', 'nonprofit' ) => 'lightSpeedOut',
		esc_html__('Rotate In', 'nonprofit' ) => 'rotateIn',
		esc_html__('Rotate In Down Left', 'nonprofit' ) => 'rotateInDownLeft',
		esc_html__('Rotate In Down Right', 'nonprofit' ) => 'rotateInDownRight',
		esc_html__('Rotate In Up Left', 'nonprofit' ) => 'rotateInUpLeft',
		esc_html__('Rotate In Up Right', 'nonprofit' ) => 'rotateInUpRight',
		esc_html__('Slide In Up', 'nonprofit' ) => 'slideInUp',
		esc_html__('Slide In Down', 'nonprofit' ) => 'slideInDown',
		esc_html__('Slide In Left', 'nonprofit' ) => 'slideInLeft',
		esc_html__('Slide In Right', 'nonprofit' ) => 'slideInRight',
		esc_html__('Zoom In ', 'nonprofit' ) => 'zoomIn',
		esc_html__('Zoom In Down', 'nonprofit' ) => 'zoomInDown',
		esc_html__('Zoom In Left', 'nonprofit' ) => 'zoomInLeft',
		esc_html__('Zoom In Right', 'nonprofit' ) => 'zoomInRight',
		esc_html__('Zoom In Up', 'nonprofit' ) => 'zoomInUp',
		esc_html__('Roll In', 'nonprofit' ) => 'rollIn',
	),
	'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'nonprofit' )
);


get_template_part('inc/vcomposer/vc_elements/wd-headings');

get_template_part('inc/vcomposer/vc_elements/wd-empty_spaces');
...
get_template_part('inc/vcomposer/vc_elements/wd-clients');

get_template_part('inc/vcomposer/vc_elements/wd-blog');



get_template_part('inc/vcomposer/vc_elements/wd-portfolio');

get_template_part('inc/vcomposer/vc_elements/wd-text_icon');

get_template_part('inc/vcomposer/vc_elements/wd-count_up');
...
get_template_part('inc/vcomposer/vc_elements/wd-testimonial');

get_template_part('inc/vcomposer/vc_elements/wd-progressbar');

get_template_part('inc/vcomposer/vc_elements/wd-pricing_table');

get_template_part('inc/vcomposer/vc_elements/wd-list');

get_template_part('inc/vcomposer/vc_elements/wd-button');

get_template_part('inc/vcomposer/vc_elements/wd-drop_caps');

get_template_part('inc/vcomposer/vc_elements/wd-causes');
...
vc_add_param("contact-form-7",
	$vc_add_css_animation
);



get_template_part('inc/vcomposer/vc_elements/wd-vc_portfolio');
get_template_part('inc/vcomposer/vc_elements/wd-progress_bars');
get_template_part('inc/vcomposer/vc_elements/wd-one_post');

get_template_part('inc/vcomposer/vc_elements/wd-chart_pie');
get_template_part('inc/vcomposer/vc_elements/wd-hero_image');
get_template_part('inc/vcomposer/vc_elements/wd-featured_box');
get_template_part('inc/vcomposer/vc_elements/wd-flip_image');
get_template_part('inc/vcomposer/vc_elements/wd-modal');
get_template_part('inc/vcomposer/vc_elements/wd-team_member');
