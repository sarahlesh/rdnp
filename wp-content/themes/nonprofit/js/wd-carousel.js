    ...
    $(window).load(function() {
        ...
        if ($('.team-member-slider').length) {
            $('.team-member-slider').each(function(i, obj) {
                nonprofit_team_slider_setting(this);
            });
        }

        function nonprofit_team_slider_setting(el) {
        ...
        if ($('.testimonial-slider').length) {
            $('.testimonial-slider').each(function(i, obj) {
                nonprofit_testimonial_slider_setting(this);
            });
        }

        function nonprofit_testimonial_slider_setting(el) {
            var $data = $(el).data('infinity');
            $(el).owlCarousel({
                loop: $data,
                margin: 0,
        ...
        if ($('.wd-clients-carousel').length) {
            $('.wd-clients-carousel').each(function(i, obj) {
                nonprofit_clients_carousel_setting(this);
            });
        }


        function nonprofit_clients_carousel_setting(el) {
        ...
        if ($('.team-member-carousel').length) {
            $('.team-member-carousel').each(function(i, obj) {
                nonprofit_team_member_carousel_setting(this);
            });
        }

        function nonprofit_team_member_carousel_setting(el) {
            if (navigation_style_carousel == "arrows") {
        ...
        if ($('.wd-portfolio-carousel').length) {
            $('.wd-portfolio-carousel').each(function(i, obj) {
                nonprofit_portfolio_carousel_setting(this);
            });
        }

        function nonprofit_portfolio_carousel_setting(el) {
              $(el).owlCarousel({
                  loop: true,
                  margin: 15,
                  nav: true,
        ...
        if ($('.wd-single-portfolio-carousel').length) {
            $('.wd-single-portfolio-carousel').each(function(i, obj) {
                nonprofit_single_portfolio_carousel_setting(this);
            });
        }

        function nonprofit_single_portfolio_carousel_setting(el) {
              $(el).owlCarousel({
                  loop: true,
                  margin: 15,
                  nav: true,
          ...
          $(".nonprofit_blog_post_gallery_masonry").owlCarousel({
		      nav: true,
		      navText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
		      items:1,
		       responsiveClass  : true,
		  ...
		  $(".nonprofit_blog_post_gallery").owlCarousel({
		      nav: true,
		      navText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
		      items:1,
		       responsiveClass  : true,
		  ...
		  $(".nonprofit_blog_post_gallery_left_image").owlCarousel({
		      nav: true,
		      navText: ["<i class='fa fa-long-arrow-left'></i>", "<i class='fa fa-long-arrow-right'></i>"],
		  ...
		  $(".nonprofit_blog_post_gallery_top_image").owlCarousel({
		      nav: true,
		      navText: ["<i class='fa fa-long-arrow-left'></i>", "<i class='fa fa-long-arrow-right'></i>"],
